  ...
  return (
    <div className="Group-36">
      <div className="Rectangle-29">
        ...
        <div className="httpswwwmeitygovincyber-surakshit-bharat-brochure">
        ...
        <div>
          ...
          <div className="A-resilient-Framework-for-collecting-and-responding-t-o-digital-crimes-and-frauds">
            A resilient Framework for collecting and responding to digital
            crimes and frauds
          </div>
          <div className="Rising-Threat-National-Concern-Action-Needed">
            Rising Threat National Concern Action Needed
          </div>
        </div>
        <div>
