            ...
            <div className="Reporttheblock">
                ...
                <div className="TextBoxText">
                    <div className="forLinks">
                        ...
                        <FaArrowRightLong className='ArrowIcon' />
                        <Link to="/pv" className="ReportButton">
                            <span className="IncidentHeader"> Privacy Violations</span>
                        </Link>
                    </div>
                    <div className="AlignmentForVictimReport">
                        ...
                        <Link to="/pv" className="BoxVictimReport">
                            <span className="TextVictimReport">privacy as it includes violations like social media breach,identity theft</span>
                        </Link>
                    </div>
