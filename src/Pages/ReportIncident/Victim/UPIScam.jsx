            ...
            <div className="Reporttheblock">
                ...
                <div className="TextBoxText">
                    <div className="forLinks">
                        ...
                        <FaArrowRightLong className='ArrowIcon' />
                        <Link to="/upi" className="ReportButton">
                            <span className="IncidentHeader">UPI</span>
                        </Link>
                    ...
                    <div className="AlignmentForVictimReport">
                        ...
                        <Link to="/upi" className="BoxVictimReport">
                            <span className="TextVictimReport">using UPI/ Credit Cards</span>
                        </Link>
                    </div>
