            ...
            <div className="Reporttheblock">
                ...
                <div className="TextBoxText">
                    <div className="forLinks">
                        ...
                        <FaArrowRightLong className='ArrowIcon' />
                        <Link to="/cyflash" className="ReportButton">
                            <span className="IncidentHeader">CyberFlashing</span>
                        </Link>
                    </div>
                    <div className="AlignmentForVictimReport">
                        ...
                        <Link to="/cyflash" className="BoxVictimReport">
                            <span className="TextVictimReport">by sending me explicit images/videos without my consent </span>
                        </Link>
                    </div>
