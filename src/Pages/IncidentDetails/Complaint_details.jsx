      ...
      get(incidentRef)
        .then((snapshot) => {
          if (snapshot.exists()) {
            ...
            // Optionally, you can set an empty array for incidentDetails if no details are found
            setIncidentDetails([]);
          }
        })
        .catch((error) => {
          console.error("Error fetching incident details:", error);
          // Optionally, you can handle the error here, e.g., displaying an error message to the user
        });
    }
  }, [currentUser, db]);
